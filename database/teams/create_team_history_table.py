...
cursor.execute('DROP TABLE IF EXISTS TEAM_NAME_HISTORY')
res = cursor.execute('''CREATE TABLE TEAM_NAME_HISTORY (
    Team_ID INT,
...
print(*cursor.execute('''PRAGMA TABLE_INFO(TEAM_NAME_HISTORY)''').fetchall(), sep="\n")
""" 
